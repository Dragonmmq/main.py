...
async def handle(msg: types.Message):
    ...
    if get_forwarding():
        try:
            ...
            logging.error(f"Ошибка в канал: {e}")
    ...
    if text:
        ...
        emoji = "🎨" if media_type == "sticker" else "🎤" if media_type == "voice" else "🔄" if media_type == "video_note" else ""
    ...
    for admin in ADMINS:
        try:
            ...
            logging.error(f"Ошибка админу: {e}")
